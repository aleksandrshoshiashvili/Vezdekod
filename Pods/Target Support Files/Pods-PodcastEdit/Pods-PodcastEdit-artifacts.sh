...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/AudioKit/AudioKit.xcframework" "" "false" "ios-arm64_armv7/AudioKit.framework" "ios-arm64_i386_x86_64-simulator/AudioKit.framework" "ios-x86_64-maccatalyst/AudioKit.framework"
  install_xcframework "${PODS_ROOT}/AudioKit/AudioKitUI.xcframework" "" "false" "ios-arm64_i386_x86_64-simulator/AudioKitUI.framework" "ios-x86_64-maccatalyst/AudioKitUI.framework" "ios-arm64_armv7/AudioKitUI.framework"
fi
